...
# 初始化与学习图片
# Get a reference to webcam #0 (the default one) 获得摄像头，可以放到下面
...
face_encodings = []
face_names = []
# Attendance list 0->Absent 1->Attendant
is_attendance = [0] * len(known_face_names)
...
while True:
    ...
    # All attendent to quit:
    if 0 not in is_attendance:
        break
