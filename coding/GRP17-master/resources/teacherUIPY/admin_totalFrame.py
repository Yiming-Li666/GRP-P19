...
# Form implementation generated from reading ui file 'admin_totalFrame1.ui'
#
...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        Frame.resize(1151, 607)
        self.stackedWidget = QtWidgets.QStackedWidget(Frame)
        self.stackedWidget.setGeometry(QtCore.QRect(280, 20, 851, 551))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(50, 30, 202, 511))
        self.layoutWidget.setObjectName("layoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.layoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 22)
        self.verticalLayout.setSpacing(20)
        self.verticalLayout.setObjectName("verticalLayout")
        self.navigator_label = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.account_pushButton = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.student_pushButton = QtWidgets.QPushButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.teacher_pushButton = QtWidgets.QPushButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.module_pushButton = QtWidgets.QPushButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.attendance_pushButton = QtWidgets.QPushButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, Form):
        ...
        self.AC_label.setText(_translate("Form", "Account"))
        self.ACcomboBox1.setItemText(0, _translate("Form", "UserType"))
        self.ACcomboBox2.setItemText(0, _translate("Form", "Faculty"))
        self.ACcomboBox3.setItemText(0, _translate("Form", "School"))
        self.ACmodify_toolButton.setText(_translate("Form", "M"))
        self.ACdelete_toolButton.setText(_translate("Form", "-"))
        self.ACadd_toolButton.setText(_translate("Form", "+"))
        self.Stu_label.setText(_translate("Form", "Student"))
        self.Stu_comboBox1.setItemText(0, _translate("Form", "Faculty"))
        self.Stu_comboBox2.setItemText(0, _translate("Form", "School"))
        self.Stu_comboBox3.setItemText(0, _translate("Form", "Year"))
        self.STUModify_toolButton.setText(_translate("Form", "M"))
        self.STUdelete_toolButton.setText(_translate("Form", "-"))
        self.STUadd_toolButton.setText(_translate("Form", "+"))
        self.teacher_label.setText(_translate("Form", "Teacher"))
        self.Tea_comboBox1.setItemText(0, _translate("Form", "Faculty"))
        self.Tea_comboBox2.setItemText(0, _translate("Form", "School"))
        self.Tea_comboBox3.setItemText(0, _translate("Form", "Type"))
        self.TEAmodify_toolButton.setText(_translate("Form", "M"))
        self.TEAdelete_toolButton.setText(_translate("Form", "-"))
        self.TEAadd_toolButton.setText(_translate("Form", "+"))
        self.module_label.setText(_translate("Form", "Module"))
        self.Module_comboBox1.setItemText(0, _translate("Form", "Faculty"))
        self.Module_comboBox2.setItemText(0, _translate("Form", "School"))
        self.Module_comboBox3.setItemText(0, _translate("Form", "Year"))
        self.TEAmodify_toolButton_2.setText(_translate("Form", "M"))
        self.TEAdelete_toolButton_2.setText(_translate("Form", "-"))
        self.TEAadd_toolButton_2.setText(_translate("Form", "+"))
        self.attendence_label.setText(_translate("Form", "Attendance"))
        self.Att_comboBox1.setItemText(0, _translate("Form", "Faculty"))
        self.Att_comboBox2.setItemText(0, _translate("Form", "School"))
        self.Att_comboBox3.setItemText(0, _translate("Form", "Year"))
        self.Att_comboBox4.setItemText(0, _translate("Form", "Course"))
        self.Att_comboBox5.setItemText(0, _translate("Form", "SessionType"))
        self.label_6.setText(_translate("Form", "Start Time:"))
        self.label_7.setText(_translate("Form", "End Time:"))
        self.ATTmodify_toolButton.setText(_translate("Form", "M"))
        self.ATTdelete_toolButton.setText(_translate("Form", "-"))
        self.ATTadd_toolButton.setText(_translate("Form", "+"))
        self.navigator_label.setText(_translate("Form", "Navigator"))
        self.account_pushButton.setText(_translate("Form", "Account Management"))
        self.student_pushButton.setText(_translate("Form", "Student Management"))
        self.teacher_pushButton.setText(_translate("Form", "Teacher Management"))
        self.module_pushButton.setText(_translate("Form", "Module Management"))
        self.attendance_pushButton.setText(_translate("Form", "Attendance Management"))
