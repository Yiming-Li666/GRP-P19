...
# Form implementation generated from reading ui file '/Users/derrickyu/Downloads/GRP17-master/resources/UI_resources/basicStructure_mainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.TeacherInfoPage = QtWidgets.QWidget()
        self.TeacherInfoPage.setObjectName("TeacherInfoPage")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.TeacherInfoPage)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.teacherInfoFrame1 = QtWidgets.QFrame(self.TeacherInfoPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(3)
        sizePolicy.setVerticalStretch(0)
        ...
        self.teacherInfoFrame2 = QtWidgets.QFrame(self.TeacherInfoPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.stackedWidget.addWidget(self.TeacherInfoPage)
        self.StudentRecordPage = QtWidgets.QWidget()
        self.StudentRecordPage.setObjectName("StudentRecordPage")
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout(self.StudentRecordPage)
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.studentRecordFrame1 = QtWidgets.QFrame(self.StudentRecordPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(3)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.studentRecordFrame1.sizePolicy().hasHeightForWidth())
        self.studentRecordFrame1.setSizePolicy(sizePolicy)
        self.studentRecordFrame1.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.studentRecordFrame1.setFrameShadow(QtWidgets.QFrame.Raised)
        self.studentRecordFrame1.setObjectName("studentRecordFrame1")
        self.horizontalLayout_9.addWidget(self.studentRecordFrame1)
        self.studentRecordFrame2 = QtWidgets.QFrame(self.StudentRecordPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.studentRecordFrame2.sizePolicy().hasHeightForWidth())
        self.studentRecordFrame2.setSizePolicy(sizePolicy)
        self.studentRecordFrame2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.studentRecordFrame2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.studentRecordFrame2.setObjectName("studentRecordFrame2")
        self.horizontalLayout_9.addWidget(self.studentRecordFrame2)
        self.stackedWidget.addWidget(self.StudentRecordPage)
        self.RecordedSessionPage = QtWidgets.QWidget()
        self.RecordedSessionPage.setObjectName("RecordedSessionPage")
        self.horizontalLayout_10 = QtWidgets.QHBoxLayout(self.RecordedSessionPage)
        self.horizontalLayout_10.setObjectName("horizontalLayout_10")
        self.RecordedSessionFrame1 = QtWidgets.QFrame(self.RecordedSessionPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(3)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.RecordedSessionFrame1.sizePolicy().hasHeightForWidth())
        self.RecordedSessionFrame1.setSizePolicy(sizePolicy)
        self.RecordedSessionFrame1.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.RecordedSessionFrame1.setFrameShadow(QtWidgets.QFrame.Raised)
        self.RecordedSessionFrame1.setObjectName("RecordedSessionFrame1")
        self.horizontalLayout_10.addWidget(self.RecordedSessionFrame1)
        self.RecordedSessionFrame2 = QtWidgets.QFrame(self.RecordedSessionPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.RecordedSessionFrame2.sizePolicy().hasHeightForWidth())
        self.RecordedSessionFrame2.setSizePolicy(sizePolicy)
        self.RecordedSessionFrame2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.RecordedSessionFrame2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.RecordedSessionFrame2.setObjectName("RecordedSessionFrame2")
        self.horizontalLayout_10.addWidget(self.RecordedSessionFrame2)
        self.stackedWidget.addWidget(self.RecordedSessionPage)
