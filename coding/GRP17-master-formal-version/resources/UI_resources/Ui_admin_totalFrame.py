...
# Form implementation generated from reading ui file '/Users/derrickyu/Desktop/GRP17-master/resources/UI_resources/admin_totalFrame.ui'
#
...
class Ui_Frame(object):
    def setupUi(self, Frame):
        ...
        self.gridLayout_5 = QtWidgets.QGridLayout(self.Student)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.frame_6 = QtWidgets.QFrame(self.Student)
        ...
        self.gridLayout_7 = QtWidgets.QGridLayout(self.Teacher)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.frame_7 = QtWidgets.QFrame(self.Teacher)
        ...
        self.gridLayout_9 = QtWidgets.QGridLayout(self.Module)
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.frame_8 = QtWidgets.QFrame(self.Module)
        ...
        self.gridLayout_11 = QtWidgets.QGridLayout(self.Attendance)
        self.gridLayout_11.setContentsMargins(-1, 0, -1, -1)
        self.gridLayout_11.setObjectName("gridLayout_11")
        self.frame_9 = QtWidgets.QFrame(self.Attendance)
        ...
        self.toolButton = QtWidgets.QToolButton(self.Attendance)
        ...
        self.ACadd_toolButton.clicked.connect(self.AccountAdd)
        self.ACdelete_toolButton.clicked.connect(self.AccountDelete)
        self.ACmodify_toolButton.clicked.connect(self.AccountModify)
        self.ACsearch_toolButton.clicked.connect(self.AccountSearch)
        self.STUModify_toolButton.clicked.connect(self.StudentModify)
        self.STUadd_toolButton.clicked.connect(self.StudentAdd)
        self.STUdelete_toolButton.clicked.connect(self.StudentDelete)
        self.Stu_toolButton.clicked.connect(self.StudentSearch)
        self.TEAadd_toolButton.clicked.connect(self.TeacherAdd)
        self.TEAadd_toolButton_2.clicked.connect(self.ModuleAdd)
        self.TEAdelete_toolButton.clicked.connect(self.TeacherDelete)
        self.TEAdelete_toolButton_2.clicked.connect(self.ModuleDelete)
        self.TEAmodify_toolButton.clicked.connect(self.TeacherModify)
        self.TEAmodify_toolButton_2.clicked.connect(self.ModuleModify)
        self.TEAsearch_toolButton.clicked.connect(self.TeacherSearch)
        self.TEAsearch_toolButton_2.clicked.connect(self.ModuleSearch)
        self.account_pushButton.clicked.connect(self.Account)
        self.attendance_pushButton.clicked.connect(self.Attendance)
        self.module_pushButton.clicked.connect(self.Module)
        self.student_pushButton.clicked.connect(self.Student)
        self.Attsearch_toolButton.clicked.connect(self.AttendanceSearch)
        self.ATTmodify_toolButton.clicked.connect(self.AttendanceModify)
        self.ATTdelete_toolButton.clicked.connect(self.AttendanceDelete)
        self.ATTadd_toolButton.clicked.connect(self.AttendanceAdd)
        self.teacher_pushButton.clicked.connect(self.Teacher)
