...
class recording_totalframe(object):
    def setupUi(self, Frame):
        ...
        self.sccessOrfail_pushbutton = QtWidgets.QToolButton(self.widget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sccessOrfail_pushbutton.sizePolicy().hasHeightForWidth())
        self.sccessOrfail_pushbutton.setSizePolicy(sizePolicy)
        self.sccessOrfail_pushbutton.setMinimumSize(QtCore.QSize(120, 120))
        self.sccessOrfail_pushbutton.setMaximumSize(QtCore.QSize(300, 300))
        self.sccessOrfail_pushbutton.setObjectName("sccessOrfail_pushbutton")
        self.horizontalLayout_2.addWidget(self.sccessOrfail_pushbutton)
    ...
    def retranslateUi(self, Frame):
        ...
        self.sccessOrfail_pushbutton.setText(_translate("Frame", "Succeed"))
